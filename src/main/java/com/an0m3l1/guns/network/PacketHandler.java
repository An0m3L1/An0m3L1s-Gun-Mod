...
public class PacketHandler
{
	...
	{
		playChannel = FrameworkAPI.createNetworkBuilder(new ResourceLocation(GunMod.MOD_ID, "play"), 1)
				...
				.registerPlayMessage(S2CMessageIncendiaryGrenadeUnderwater.class, MessageDirection.PLAY_CLIENT_BOUND)
				.registerPlayMessage(S2CMessageMolotov.class, MessageDirection.PLAY_CLIENT_BOUND)
				.registerPlayMessage(S2CMessageMolotovUnderwater.class, MessageDirection.PLAY_CLIENT_BOUND)
				...
				.registerPlayMessage(S2CMessageSound.class, MessageDirection.PLAY_CLIENT_BOUND)
