...
public class Gun implements INBTSerializable<CompoundTag>
{
	...
	public static class General implements INBTSerializable<CompoundTag>
	{
		...
		@Optional
		private final boolean magReloadWithLightMag = false;
		@Optional
		private final boolean magReloadWithExtendedMag = false;
		@Optional
		...
		public void deserializeNBT(CompoundTag tag)
		{
			...
			else if(tag.contains("ReloadSpeed", Tag.TAG_ANY_NUMERIC))
			{
		...
		public JsonObject toJsonObject()
		{
			...
			{
				object.addProperty("burstCount", this.burstCount);
			}
			if(this.burstCooldown != -1)
			{
			...
			{
				object.addProperty("defaultColor", this.defaultColor);
			}
			object.addProperty("maxAmmo", this.maxAmmo);
			if(this.lightMagAmmo != -1)
			{
				object.addProperty("lightMagAmmo", this.lightMagAmmo);
			}
			if(this.extendedMagAmmo != -1)
			{
				object.addProperty("extendedMagAmmo", this.extendedMagAmmo);
			}
			object.addProperty("overCapacityAmmo", this.overCapacityAmmo);
			if(this.infiniteAmmo)
			{
				object.addProperty("infiniteAmmo", this.infiniteAmmo);
			}
			...
			{
				object.addProperty("itemsPerAmmo", this.ammoPerShot);
			}
			if(this.ammoPerItem != 1)
			{
				object.addProperty("ammoPerItem", this.ammoPerItem);
			}
			if(this.reloadRate != 10)
			{
				object.addProperty("reloadRate", this.reloadRate);
			}
			if(this.reloadStartDelay != 5)
			{
				object.addProperty("reloadStartDelay", this.reloadStartDelay);
			}
			if(this.reloadInterruptDelay != 5)
			{
				object.addProperty("reloadInterruptDelay", this.reloadInterruptDelay);
			}
			if(this.reloadEndDelay != -1)
			{
				object.addProperty("reloadEndDelay", this.reloadEndDelay);
			}
			if(this.reloadEmptyStartDelay != -1)
			{
				object.addProperty("reloadEmptyStartDelay", this.reloadEmptyStartDelay);
			}
			if(this.reloadEmptyInterruptDelay != -1)
			{
				object.addProperty("reloadEmptyInterruptDelay", this.reloadEmptyInterruptDelay);
			}
			if(this.reloadEmptyEndDelay != -1)
			{
				object.addProperty("reloadEmptyEndDelay", this.reloadEmptyEndDelay);
			}
			if(this.useMagReload)
			{
				object.addProperty("useMagReload", this.useMagReload);
			}
			if(this.magReloadWhenEmpty)
			{
				object.addProperty("magReloadWhenEmpty", this.magReloadWhenEmpty);
			}
			if(this.noMagReloadWithScope)
			{
				object.addProperty("noMagReloadWithScope", this.noMagReloadWithScope);
			}
			if(this.magReloadTime != 0)
			{
				object.addProperty("magReloadTime", this.magReloadTime);
			}
			if(this.magReloadFromEmptyTime != 0)
			{
				object.addProperty("magReloadFromEmptyTime", this.magReloadFromEmptyTime);
			}
			if(this.lightMagReloadTimeModifier != 0.85)
			{
				object.addProperty("lightMagReloadTimeModifier", this.lightMagReloadTimeModifier);
			}
			if(this.extendedMagReloadTimeModifier != 1.15)
			{
				object.addProperty("extendedMagReloadTimeModifier", this.extendedMagReloadTimeModifier);
			}
			if(this.reloadAllowedCooldown != 1)
			{
				object.addProperty("reloadAllowedCooldown", this.reloadAllowedCooldown);
			}
			...
			{
				object.addProperty("spreadAdsReduction", this.spread);
			}
			if(this.useShotgunSpread)
			{
				object.addProperty("useShotgunSpread", true);
			}
			if(this.useSniperSpread)
			{
				object.addProperty("useSniperSpread", true);
			}
			if(this.adsSpeed != 1)
			{
				object.addProperty("adsSpeed", this.adsSpeed);
			}
			if(this.doRampUp)
			{
				object.addProperty("doRampUp", false);
			}
			if(this.rampUpShotsNeeded != 8)
			{
				object.addProperty("rampUpShotsNeeded", this.rampUpShotsNeeded);
			}
			if(this.spawnCasings)
			{
				object.addProperty("spawnCasings", this.spawnCasings);
			}
			if(this.emitLight)
			{
				object.addProperty("emitLight", this.emitLight);
			}
			return object;
		}
		...
		/**
		 * @return The modifier to reload speed when an extended magazine is attached.
		 */
	...
	public static class FireModes implements INBTSerializable<CompoundTag>
	{
		...
		public JsonObject toJsonObject()
		{
			...
			Preconditions.checkArgument(true, "Default Fire Mode must be a valid fire mode equivalent integer, or set to negative one to calculate it automatically.");
			object.addProperty("useFireModes", this.useFireModes);
			if(this.defaultFireMode != -1)
			{
				object.addProperty("defaultFireMode", this.defaultFireMode);
			}
			if(this.hasSemiMode)
			{
				object.addProperty("hasSemiMode", this.hasSemiMode);
			}
			if(this.hasAutoMode)
			{
				object.addProperty("hasAutoMode", this.hasAutoMode);
			}
			if(this.hasBurstMode)
			{
				object.addProperty("hasBurstMode", this.hasBurstMode);
			}
			if(this.useAutoBurst)
			{
				object.addProperty("useAutoBurst", this.useAutoBurst);
			}
			if(this.burstCount != 0)
			{
				object.addProperty("burstCount", this.burstCount);
	...
	public static class Projectile implements INBTSerializable<CompoundTag>
	{
		...
		public CompoundTag serializeNBT()
		{
			...
			{
				tag.putString("ProjectileItem", this.item.toString());
			}
		...
		public JsonObject toJsonObject()
		{
			...
			Preconditions.checkArgument(this.explosionRadius > 0.0F, "Explosion radius must be higher than 0.0");
			JsonObject object = new JsonObject();
			...
			if(this.griefing)
			{
				object.addProperty("griefing", true);
			}
			object.addProperty("damage", this.damage);
			if(this.maxRangeDamageMultiplier != 0.0F)
			{
				object.addProperty("maxRangeDamageMultiplier", this.maxRangeDamageMultiplier);
			}
			if(this.maxPierceCount != 0)
			{
				object.addProperty("maxPierceCount", this.maxPierceCount);
			}
			if(this.pierceDamagePenalty != 0.2)
			{
				object.addProperty("pierceDamagePenalty", this.pierceDamagePenalty);
			}
			if(this.pierceDamageMaxPenalty != 0.8)
			{
				object.addProperty("pierceDamageMaxPenalty", this.pierceDamageMaxPenalty);
			}
			if(this.waterDamagePenalty != 0.5F)
			{
				object.addProperty("waterDamagePenalty", this.waterDamagePenalty);
			}
			if(this.headshotExtraDamage != 0.0F)
			{
				object.addProperty("headshotExtraDamage", this.headshotExtraDamage);
			}
			if(this.headshotMultiplierBonus != 0.0F)
			{
				object.addProperty("headshotMultiplierBonus", this.headshotMultiplierBonus);
			}
			if(this.headshotMultiplierMin != 1.0F)
			{
				object.addProperty("headshotMultiplierMin", this.headshotMultiplierMin);
			}
			if(this.headshotMultiplierOverride != 0.0F)
			{
				object.addProperty("headshotMultiplierOverride", this.headshotMultiplierOverride);
			}
		 ...
		 */
		public @Nullable String getProjectileOverride()
		{
		...
		/**
		 * @return The maximum number of entities the projectile can pierce in its base state.
		...
		/**
		 * @return The extra damage (after multipliers) caused by landing a headshot.
		 */
		...
		/**
		 * @return How big should the explosion produced by this projectile be.
		 */
	...
	public static class Sounds implements INBTSerializable<CompoundTag>
	{
		...
		public JsonObject toJsonObject()
		{
			...
			if(this.reloadFrames != 1)
			{
				object.addProperty("reloadFrames", this.reloadFrames);
			}
			...
			if(this.reloadEarlyThreshold != -1)
			{
			...
			if(this.reloadClipOutThreshold != -1)
			{
			...
			if(this.reloadClipInThreshold != -1)
			{
			...
			{
				object.addProperty("cycleDelay", this.cycleDelay);
			}
			...
			if(this.weaponSelectDelay >= 0)
			{
				object.addProperty("weaponSelectDelay", this.weaponSelectDelay);
			}
		...
		{
			return this.reloadEarly != null || this.reloadMid != null || this.reloadLate != null || this.reloadEnd != null || this.reloadClipOut != null || this.reloadClipIn != null;
		}
	...
	public static class ReloadSoundsBase implements INBTSerializable<CompoundTag>
	{
		...
		public Boolean hasExtraReloadSounds()
		{
			return this.reloadEarly != null || this.reloadMid != null || this.reloadLate != null || this.reloadClipOut != null || this.reloadClipIn != null;
		}
			...
			IAttachment.Type type)
	{
		if(this.modules.attachments != null && type != null)
		{
			return switch(type)
			{
				...
				case TACTICAL -> this.modules.attachments.tactical != null;
	...
	public static ReloadSoundsBase findReloadSoundObj(Gun gun, String soundType, boolean magReload, boolean emptyReload)
	{
		...
		for(int i = 0; i < 4; i++)
		{
			if(i > 0)
			{
				...
				else if(tryMagReload && emptyReload)
				{
					tryMagReload = false;
					tryEmptyReload = true;
				}
	...
	protected static ResourceLocation getReloadSoundEventDynamic(ReloadSoundsBase soundObject, String soundType)
	{
		...
		if(Objects.equals(soundType, "reloadStart"))
		{
			output = soundObject.getReloadStart();
		}
		else if(Objects.equals(soundType, "reloadEarly"))
		{
			output = soundObject.getReloadEarly();
		}
		else if(Objects.equals(soundType, "reloadMid"))
		{
			output = soundObject.getReloadMid();
		}
		else if(Objects.equals(soundType, "reloadLate"))
		{
			output = soundObject.getReloadLate();
		}
		else if(Objects.equals(soundType, "reloadEnd"))
		{
			output = soundObject.getReloadEnd();
		}
		else if(Objects.equals(soundType, "reloadClipOut"))
		{
			output = soundObject.getReloadClipOut();
		}
		else if(Objects.equals(soundType, "reloadClipIn"))
		{
			output = soundObject.getReloadClipIn();
		}
		else if(Objects.equals(soundType, "reload"))
		{
	...
	protected static double getReloadSoundTimingDynamic(ReloadSoundsBase soundObject, String soundType)
	{
		...
		if(Objects.equals(soundType, "reloadStart"))
		{
			output = soundObject.getReloadStartDelay();
		}
		else if(Objects.equals(soundType, "reloadEarly"))
		{
			output = soundObject.getReloadEarlyThreshold();
		}
		else if(Objects.equals(soundType, "reloadMid"))
		{
			output = soundObject.getReloadMidThreshold();
		}
		else if(Objects.equals(soundType, "reloadLate"))
		{
			output = soundObject.getReloadLateThreshold();
		}
		else if(Objects.equals(soundType, "reloadEnd"))
		{
			output = soundObject.getReloadEndDelay();
		}
		else if(Objects.equals(soundType, "reloadClipOut"))
		{
			output = soundObject.getReloadClipOutThreshold();
		}
		else if(Objects.equals(soundType, "reloadClipIn"))
		{
			output = soundObject.getReloadClipInThreshold();
		}
