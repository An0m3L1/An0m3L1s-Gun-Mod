...
import com.an0m3l1.guns.client.render.IHeldAnimation;
import com.an0m3l1.guns.client.render.pose.*;
...
public record GripType(ResourceLocation id, IHeldAnimation getHeldAnimation)
{
	 ...
	 *
	 * @param player
	 * 		the player the weapon is being rendered on
	 * @param poseStack
	 * 		the matrixstack get
	 *
	...
	/**
	 * Gets the grip type associated the id. If the grip type does not exist, it will default to
	 * one-handed.
	 *
	 * @param id
	 * 		the id of the grip type
	 *
	 * @return returns a get of the grip type or ONE_HANDED if it doesn't exist
	 */
