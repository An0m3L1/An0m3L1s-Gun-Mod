	...
	public static class Common
	{
		...
		public Common(ForgeConfigSpec.Builder builder)
		{
			builder.push("griefing");
			{
				...
				this.projectileGriefing = builder.comment("If enabled, projectiles and explosions will destroy destructible blocks. This doesn't require universal explosion griefing to be enabled.").define("projectileGriefing", true);
				this.projectileGriefingBlockDrops = builder.comment("If enabled, destructible blocks will drop when broken.").define("projectileGriefingBlockDrops", false);
	...
	public static class Server
	{
		...
		public Server(ForgeConfigSpec.Builder builder)
		{
			builder.push("grenades");
			{
				...
				{
					this.impactGrenadeExplosionRadius = builder.comment("Radius of an Impact Grenade explosion.").defineInRange("impactGrenadeExplosionRadius", 2.5, 0.0, Double.MAX_VALUE);
					this.impactGrenadeExplosionDamage = builder.comment("Damage of an Impact Grenade explosion.").defineInRange("impactGrenadeExplosionDamage", 22.0, 0.0, Double.MAX_VALUE);
				...
				{
					this.incendiaryGrenadeExplosionRadius = builder.comment("Radius of an Incendiary Grenade explosion.").defineInRange("incendiaryGrenadeExplosionRadius", 3.0, 0.0, Double.MAX_VALUE);
