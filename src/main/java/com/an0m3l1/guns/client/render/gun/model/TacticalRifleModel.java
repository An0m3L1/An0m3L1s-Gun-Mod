...
/** Author: An0m3L1 */
public class TacticalRifleModel implements IOverrideModel
{
	private boolean disableAnimations = false;
	
	@Override
	// This class renders a multipart model that supports animations and removable parts.
	                   ...
	                   LivingEntity entity, PoseStack poseStack, MultiBufferSource buffer, int light, int overlay)
	{
		...
		{
			RenderUtil.renderModel(SpecialModels.TACTICAL_RIFLE_SIGHTS.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
		}
