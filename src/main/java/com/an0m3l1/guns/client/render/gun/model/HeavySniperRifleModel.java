...
/** Author: An0m3L1 */
public class HeavySniperRifleModel implements IOverrideModel
{
	                   ...
	                   LivingEntity entity, PoseStack poseStack, MultiBufferSource buffer, int light, int overlay)
	{
		...
		{
			RenderUtil.renderModel(SpecialModels.HEAVY_SNIPER_RIFLE_SIGHTS.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
		}
		...
		RenderUtil.renderModel(SpecialModels.HEAVY_SNIPER_RIFLE_BOLT.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
		poseStack.popPose();
		...
		RenderUtil.renderModel(SpecialModels.HEAVY_SNIPER_RIFLE_CHAMBER.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
		poseStack.popPose();
		...
		RenderUtil.renderModel(SpecialModels.HEAVY_SNIPER_RIFLE_MAG.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
		poseStack.popPose();
	}
}